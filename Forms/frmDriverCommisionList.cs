...
{
    public partial class frmDriverCommisionList : UI.SetupBase
    {
        DriverCommisionBO objMaster = null;
        RadDropDownMenu AddCommisionItems = null;
        
        public frmDriverCommisionList()
        {
            InitializeComponent();
        ...
        void AddCommisionItems2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int id = grdLister.CurrentRow.Cells["Id"].Value.ToInt();
                    frmCommisionList frm = new frmCommisionList(id);
                    frm.Show();
                }
            }
            catch (Exception ex)
        ...
        private void btnLastStatement_Click(object sender, EventArgs e)
        {
            ...
            frmDriverCommissionLastStatement frm = new frmDriverCommissionLastStatement();
