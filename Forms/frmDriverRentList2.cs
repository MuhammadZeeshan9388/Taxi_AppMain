...
{
    public partial class frmDriverRentList2 : UI.SetupBase
    {
        ...
        void AddRentItems1_Click(object sender, EventArgs e)
        {
            try
            {
                if (grdLister.CurrentRow != null && grdLister.CurrentRow is GridViewDataRowInfo)
                {
                    ...
                    //else
                    //{
                        if (AppVars.listUserRights.Count(c => c.formName == "frmDriverRentDebitCredit2") > 0)
                        {
                            frmDriverRentDebitCredit2 frm = new frmDriverRentDebitCredit2(id);
        ...
        void AddRentItems2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int id = grdLister.CurrentRow.Cells["Id"].Value.ToInt();
                    frmRentList2 frm = new frmRentList2(id);
                    frm.Show();
                }
            }
            catch (Exception ex)
        ...
        void frmCompanyInvoiceList_Shown(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.InitializeForm("frmDriverRentDebitCredit2");
        ...
        {
            frmDriverRentLastStatement2 frm = new frmDriverRentLastStatement2();
