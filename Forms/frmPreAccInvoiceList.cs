...
{
    public partial class frmPreAccInvoiceList : UI.SetupBase
    {
        InvoiceBO objMaster = null;
        public frmPreAccInvoiceList()
        {
            InitializeComponent();
        ...
        void frmCompanyInvoiceList_Shown(object sender, EventArgs e)
        {
            ...
            try
            {
                this.InitializeForm("frmPreAccInvoice");
        ...
        private void LoadInvoiceList()
        {
            ...
            var query = from a in General.GetQueryable<Invoice>(c=>c.InvoiceTypeId==Enums.INVOICE_TYPE.PRE_INVOICE_ACCOUNT)
        ...
        private void ViewDetailForm()
        {
            try
            {
                ...
                if (grdLister.CurrentRow != null && grdLister.CurrentRow is GridViewDataRowInfo)
                {
                    ...
                    General.ShowPreCompanyInvoiceForm(id);
                }
                else
                {
