...
{
    public partial class frmAddAllDriverCommissionExpenses4 : UI.SetupBase
    {
        ...
        public frmAddAllDriverCommissionExpenses4()
        {
                ...
                var list2 = (from a in General.GetGeneralList<Booking>(c => 
                    ...
                    && ((RentForProcessedJobs == true && (c.IsProcessed != null && c.IsProcessed == true)) || (RentForProcessedJobs == false && (c.IsProcessed == null || c.IsProcessed == false)))
                             ...
                             select new
                             {
                                 ...
                                 AgentCommission = 0,//a.AgentCommission,
                                 DropOffCharge = 0,
                                 PickupCharge = 0
                             }).ToList();
              ...
              //{
                ...
                //    }
                 ...
                 //   objMaster.Current.Extra = 0;// Extra.ToDecimal();
                    ...
                    objMaster.Current.TransactionType = Enums.TRANSACTIONTYPE.DRIVER_COMMISSION_EXPENSE4;
        ...
        private void EmailInvoices()
        {
            try
            {
                ...
                if (invoiceIds.Count > 0)
                {
                    ...
                    frmDriverCommisionTransactionExpensesReport4 frm = new frmDriverCommisionTransactionExpensesReport4(1);
            ...
            try
            {
                ...
                foreach (var row in grdDriverCommission.Rows.Where(c => c.Cells["Check"].Value.ToBool()))
                {
                    ...
                    try
                    {
                        ...
                        //
                        //NC
                        //owed = (totalCredit - totalDebit+owed);
                        totalDebit = owed;
        ...
        private void btnViewPrint_Click(object sender, EventArgs e)
        {
                ...
                try
                {
                  ...
                  //  List<long> invoiceIds = rows.Select(c => c.Cells[COLS.CommissionId].Value.ToLong()).ToList<long>();
                    ...
                    if (list.Count > 0)
                    {
                        frmDriverCommisionTransactionExpensesReport4 frm = new frmDriverCommisionTransactionExpensesReport4(list, dtpFromDate.Value.ToDate(), dtpTillDate.Value.ToDate());
                        frm.ShowDialog();
                        frm.Dispose();
                    }
                }
