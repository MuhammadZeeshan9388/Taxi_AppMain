...
{
    public partial class frmDriverCommissionLastStatement : UI.SetupBase
    {
        private bool IsFareAndWaitingWiseComm;
        public frmDriverCommissionLastStatement()
        {
            InitializeComponent();
            FormatGrid();
        ...
        private void PrintStatement()
        {
            try
            {
                ...
                //                frmDriverCommisionTransactionExpensesReport2 frm = null;
                //                if (Id > 0)
                //                {
                //                    frm = new frmDriverCommisionTransactionExpensesReport2(1);
                ...
                if (grdDriverRentLastStatement.Rows.Where(c => c.Cells["Check"].Value.ToBool() == true).Count() > 0)
                {
                    ...
                    if (list.Count > 0)
                    {
                        frmDriverCommisionTransactionExpensesReport frm = new frmDriverCommisionTransactionExpensesReport(list, DateTime.Now.ToDate(), DateTime.Now.ToDate());
                        frm.ShowDialog();
                        frm.Dispose();
                    }
        ...
        //                long Id = item.Cells[COLS.Id].Value.ToLong();
        //                ReportPrintDocument rpt = null;
        //                frmDriverCommisionTransactionExpensesReport frm = null;
        //                if (Id > 0)
        //                {
        //                    frm = new frmDriverCommisionTransactionExpensesReport(1);
