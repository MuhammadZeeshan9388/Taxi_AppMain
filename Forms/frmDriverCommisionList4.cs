...
{
    public partial class frmDriverCommisionList4 : UI.SetupBase
    {
        DriverCommisionBO objMaster = null;
        RadDropDownMenu AddCommisionItems = null;

        public frmDriverCommisionList4()
        {
            InitializeComponent();
        ...
        void AddCommisionItems1_Click(object sender, EventArgs e)
        {
            try
            {
                if (grdLister.CurrentRow != null && grdLister.CurrentRow is GridViewDataRowInfo)
                {
                    ...
                    frmDriverCommissionDebitCredit4 frm = new frmDriverCommissionDebitCredit4(id);
        ...
        void AddCommisionItems2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int id = grdLister.CurrentRow.Cells["Id"].Value.ToInt();
                    frmCommisionList4 frm = new frmCommisionList4(id);
                    frm.Show();
                }
            }
            catch (Exception ex)
        ...
        void frmCompanyInvoiceList_Shown(object sender, EventArgs e)
        {
            ...
            //else
            //{
                this.InitializeForm("frmDriverCommissionDebitCredit4");
        ...
        void btnLastStatement_Click(object sender, EventArgs e)
        {
            ...
            frmDriverCommissionLastStatement4 frm = new frmDriverCommissionLastStatement4();
