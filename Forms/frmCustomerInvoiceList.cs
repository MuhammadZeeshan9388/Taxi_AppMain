...
{
    public partial class frmCustomerInvoiceList  : UI.SetupBase
    {
        InvoiceBO objMaster = null;
        public frmCustomerInvoiceList()
        {
            InitializeComponent();
        ...
        private void ViewDetailForm()
        {
            ...
            {
                General.ShowCustomerInvoiceForm(grdLister.CurrentRow.Cells["Id"].Value.ToLong());
            }
            else
            {
