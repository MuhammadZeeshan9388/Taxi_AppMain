...
{
    public partial class frmCustomerExcDriversList : Form
       ...
       
    {
        ...
        public frmCustomerExcDriversList(string values,int Id)
        {
            ...
            this.Shown += new EventHandler(frmBookingExcDriversList_Shown);

        }

        void frmBookingExcDriversList_Shown(object sender, EventArgs e)
        {
           // chkPermanentCustNotes.Checked = IsPermament;
        }
