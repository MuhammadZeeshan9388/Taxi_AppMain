                            ...
                            if (objBookngBo.Current != null)
                            {
                                ...
                                if (objBookngBo.Current.CompanyId == null)
                                {
                                    objBookngBo.Current.TotalCharges = objBookngBo.Current.FareRate.ToDecimal()
                                                 + objBookngBo.Current.ExtraDropCharges.ToDecimal() + objBookngBo.Current.MeetAndGreetCharges.ToDecimal() + objBookngBo.Current.CongtionCharges.ToDecimal();
                                }
                                else
                                {
                                    objBookngBo.Current.TotalCharges = objBookngBo.Current.CompanyPrice.ToDecimal() + objBookngBo.Current.ParkingCharges.ToDecimal() + objBookngBo.Current.WaitingCharges.ToDecimal() + objBookngBo.Current.ExtraDropCharges.ToDecimal();
