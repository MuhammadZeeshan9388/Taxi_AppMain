...
{
    public partial class frmTransferJob : Form
    {
        ...
        public frmTransferJob(Booking booking)
        {
            InitializeComponent();
        ...
        private void TransferJob()
        {
            try
            {
                ...
                {
                    db.stp_TransferJob(this.JobId, ThirdPartyCompanyId, numTransferJobCommission.Value.ToDecimal());
