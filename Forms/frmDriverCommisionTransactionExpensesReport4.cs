...
{
    public partial class frmDriverCommisionTransactionExpensesReport4 : UI.SetupBase
    {
        ...
        int IsCheck = 0;
        public frmDriverCommisionTransactionExpensesReport4(int val)
        {
            InitializeComponent();
        ...
        public frmDriverCommisionTransactionExpensesReport4(IList LIST,DateTime from, DateTime till)
        {
            InitializeComponent();
