...
{
    public partial class frmDriverCommissionDebitCredit4 : UI.SetupBase
    {
        ...
        public frmDriverCommissionDebitCredit4()
        {
            InitializeComponent();
            InitializeConstructor();

        }
        public frmDriverCommissionDebitCredit4(int Id)
        {
            InitializeComponent();
            InitializeConstructor();
       ...
       //     txtFuel.Text = objMaster.Current.Fuel.ToDecimal().ToStr();
        ...
        private void CalculateTotal()
        {
            try
            {
                ...
                decimal parkingTotal = grdLister.Rows.Sum(c => c.Cells[COLS.Parking].Value.ToDecimal());
           ...
           //     totalCredit = (commissionTotal + Credit + (spnAccountExpenses.Value.ToDecimal()) + numAgentFeeTotal.Value + numTotalCollectionDelivery.Value+numpdaRent.Value);
            //    totalDebit = (txtTotalAccountBooking.Text.TrimStart('£', ' ').ToDecimal() + Debit);
                ...
                totalCredit = (txtTotalAccountBooking.Text.TrimStart('£', ' ').ToDecimal() + spnAccountExpenses.Value.ToDecimal() + parkingTotal+ Credit);
       ...
       //     }
        ...
        public override void Print()
        {
            ...
            DockWindow doc = UI.MainMenuForm.MainMenuFrm.GetDockByName("frmDriverCommisionTransactionExpensesReport41");
