    ...
    public partial class frmAdvanceBookingCustomization : RadForm
    {
        ...
        private void DisplayBookings()
        {
            ...
            try
            {
                ...
                var bookinglist = General.GetQueryable<Booking>(c => c.AdvanceBookingId == ObjAdvanceBooking.Id && c.BookingStatusId != Enums.BOOKINGSTATUS.CANCELLED).ToList();
                ...
                for (int i = 0; i < rowCnt; i++)
                {
                    if (i == 0)
                    {
                        ...
                        //else
                        //{
                        //    txtReturnSpecialRequirement.Visible = false;
                        //    lblReturnSpecialReq.Visible = false;
                        //}
                        if (bookinglist[i].CompanyId > 0)
                        {
                            ddlAccount.SelectedValue = bookinglist[i].CompanyId.ToInt();
                        }
                        if (bookinglist[i].VehicleTypeId > 0)
                        {
                        ...
                        if (ShowOrderNo == false)
                        {
                            if (bookinglist[i].CompanyId > 0)
                            {
                                var query = General.GetObject<Gen_Company>(c => c.Id == bookinglist[i].CompanyId.ToIntorNull());
                                if (query.HasOrderNo == true)
                                {
                            ...
                            {
                                if (AppVars.objPolicyConfiguration.ShowAllJobsOrderNo.ToBool() == true)
                                {
                                    lblOrderNo.Visible = true;
                                    txtOrderNo.Visible = true;
                                    txtOrderNo.Text = bookinglist[i].OrderNo.ToStr();
                    ...
                    //if (bookinglist[i].BookingStatusId.ToIntorNull() != Enums.BOOKINGSTATUS.CANCELLED)
                    //{
                ...
                for (int i = 0; i < grdBookings.Rows.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (objMaster.Current.JourneyTypeId == Enums.JOURNEY_TYPES.RETURN)
                            {
                                objMaster.Current.SpecialRequirements = txtReturnSpecialRequirement.Text.Trim();
                            }
                            //bool ShowOrderNo = AppVars.objPolicyConfiguration.ShowAllJobsOrderNo.ToBool();
                            if (txtOrderNo.Visible == true)
                            {
