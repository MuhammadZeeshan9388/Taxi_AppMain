...
public class WebService
{
    ...
    private void ExtractResult(string methodName)
    {
        ...
        //var r = ResponseSOAP.Descendants();
        //var node = ResponseSOAP.LastNode;

        this.EtaKey= ResponseSOAP.Root.Value;//.getElementsByTagName("title")[0];
       // this.EtaKey = key;
        ...
        //    ResultXML = ENUtils.RemoveNamespaces(ResultXML);
