...
{
    public partial class rptfrmVehicleListReportViewer : UI.SetupBase
    {
        bool IsReportLoaded = false;

        private List<stp_GetVehicleListReportResult> _DataSource;

        public List<stp_GetVehicleListReportResult> DataSource
        {
        ...
        public rptfrmVehicleListReportViewer()
        {
            InitializeComponent();
        ...
        public void ExportReportToExcel()
        {
            ...
            saveFileDlg.FileName = "Driver List Report";
        ...
        {         
            ...
            saveFileDlg.Title = "Save File";
            saveFileDlg.FileName = "Vehicle List Report";
        ...
        {
            General.ShowEmailForm(reportViewer1, "Driver List Report");
        }
        ...
        public void GenerateReport()
        {
           ...
           // this.reportViewer1.LocalReport.ReportEmbeddedResource = "Taxi_AppMain.ReportDesigns." + this.TemplateValue;
            ...
            this.stp_GetVehicleListReportResultBindingSource.DataSource = _DataSource;
