...
{
    public partial class rptfrmDriverLoginHistoryReport : UI.SetupBase
    {
        public rptfrmDriverLoginHistoryReport()
        {
            InitializeComponent();
        ...
        private void GenerateReport()
        {
            try
            {
                ...
                vu_DriverLoginHistoryBindingSource.DataSource = General.GetQueryable<vu_DriverLoginHistory>(c => (driverid==0 || c.DriverId == driverid) && (c.VehicleTypeId == vehicleId)
                                                                        && (
