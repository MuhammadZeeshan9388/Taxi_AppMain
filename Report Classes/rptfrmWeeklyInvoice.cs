...
{
    public partial class rptfrmWeeklyInvoice : UI.SetupBase
    {
        bool IsReportLoded = false;
        private List<stp_WeeklyInvoiceResult> _DataSource;

        public List<stp_WeeklyInvoiceResult> DataSource
        {
        ...
        //}
        public rptfrmWeeklyInvoice()
        {

            InitializeComponent();
        }

        private void rptfrmWeeklyInvoice_Load(object sender, EventArgs e)
        {
            DefaultDate();
        }
        ...
        public void LoadReport()
        {
            try
            {
                ...
                var list = (from a in new Taxi_Model.TaxiDataContext().stp_WeeklyInvoice(fromDate, tillDate)
                            select new stp_WeeklyInvoiceResult
                            {
                                CompanyCode = a.CompanyCode,
                                AccountNo = a.AccountNo,
                                CompanyName = a.CompanyName,
                                InvoiceNo=a.InvoiceNo,
                                NoOfInvoices=a.NoOfInvoices,
                ...
                this.stp_WeeklyInvoiceResultBindingSource.DataSource = list;
        ...
        public void ExportReport()
        {
            ...
            saveFileDlg.FileName = "Weekly Invoice Report";
        ...
        private List<stp_WeeklyInvoiceResult> GetData(DateTime? fromDate, DateTime? tillDate)
        {
            return (from a in new Taxi_Model.TaxiDataContext().stp_WeeklyInvoice(fromDate, tillDate)
                    select new stp_WeeklyInvoiceResult
                    {
                        AccountNo = a.AccountNo,
                        CompanyName = a.CompanyName,
        ...
        {
            General.ShowEmailForm(reportViewer1, "Weekly Invoice Report");
        }
