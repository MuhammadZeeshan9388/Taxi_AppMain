...
{
    public partial class frmDriverRentTransactionExpensesReport : UI.SetupBase
    {
        ...
        public frmDriverRentTransactionExpensesReport(int val)
        {
            InitializeComponent();
        ...
        private void EmailInvoices(long TransId)
        {
            ...
            try
            {
                ...
                if (invoiceIds.Count > 0)
                {
                    ...
                    frmDriverRentTransactionExpensesReport frm = new frmDriverRentTransactionExpensesReport(1);
