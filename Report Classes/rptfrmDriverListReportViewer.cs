...
{
    public partial class rptfrmDriverListReportViewer : UI.SetupBase
    {
        bool IsReportLoaded = false;

        private List<stp_GetDriversListReportResult> _DataSource;

        public List<stp_GetDriversListReportResult> DataSource
        {
        ...
        public rptfrmDriverListReportViewer()
        {
            InitializeComponent();
        ...
        public void GenerateReport()
        {
           ...
           // this.reportViewer1.LocalReport.ReportEmbeddedResource = "Taxi_AppMain.ReportDesigns." + this.TemplateValue;
            ...
            this.stp_GetDriversListReportResultBindingSource.DataSource = _DataSource;
